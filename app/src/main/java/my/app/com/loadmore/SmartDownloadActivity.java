...
import my.app.com.loadmore.impl.SmartDownloadProgressListener;
import my.app.com.loadmore.impl.SmartFileDownloader;
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (downloadbar.getProgress() == downloadbar.getMax())
                        Toast.makeText(SmartDownloadActivity.this, R.string.success, Toast.LENGTH_SHORT).show();
                    break;

                case -1:
                    Toast.makeText(SmartDownloadActivity.this, R.string.error, Toast.LENGTH_SHORT).show();
                    break;
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                    ...
                    Toast.makeText(SmartDownloadActivity.this, R.string.sdcarderror, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
